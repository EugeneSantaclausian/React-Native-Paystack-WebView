...
const Paystack = ({ paystackKey, billingEmail, phone, lastName, firstName, amount = '0.00', currency = 'GHS', channels = ['card', 'mobile_money'], refNumber, billingName, handleWebViewMessage, onCancel, autoStart = false, onSuccess, activityIndicatorColor = 'green', }, ref) => {
